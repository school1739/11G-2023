...
a_1 = violator_songs[3][1] + violator_songs[5][1] + violator_songs[3][-1]
print(f"Три песни звучат {round(a, 2)} минут")
...
a_2 = pocket_universe_songs['On Track'] + pocket_universe_songs['To the Sea'] + pocket_universe_songs['Beyond Mirrors']
print(f"А другие три песни звучат приблизительно {round(a_2)} минут")
